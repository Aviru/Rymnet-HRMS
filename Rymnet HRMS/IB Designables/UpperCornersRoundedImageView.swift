//
//  UpperCornersRoundedImageView.swift
//  Rymnet HRMS
//
...
class UpperCornersRoundedImageView: UIImageView {
 ...
 */
    ...
    func setup() {
       ...
       // border!.frame = bounds
        let pathUsingCorrectInsetIfAny = UIBezierPath(roundedRect: border!.bounds, byRoundingCorners: [.topLeft , .topRight], cornerRadii: CGSize(width: 6, height: 6))
